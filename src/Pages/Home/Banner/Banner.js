...
const Banner = () => {
    return (
        <div className='md:flex justify-center items-center bg-[#e8e8e6] pt-16 md:pt-0'>
            <div>
                <p className='text-2xl font-mono mb-2 text-center md:text-left'>SHOP TO GET WHAT YOU LOVE</p>
                <h1 className='md:text-7xl text-6xl text-center font-[Barlow] font-black'>Ready To Spoil <br /> Every Moment</h1>
               <p className='mt-4 text-xl text-[#918b91]'>Best Used Camera for affordable price.</p>
